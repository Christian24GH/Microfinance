...
include __DIR__.'/config/ar_loanacc_conn.php';
include __DIR__.'/config/ar_loanacc_btnfunc.php';
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header bg-primary text-white">
                            <h1 class="modal-title fs-5" id="editdataLabel">Edit Loan Account</h1>
                        </div>
                        <form action="../modal_function/ar_loanaccfunc.php" method="POST">
                            <div class="modal-body">
                                <div class="mb-3">
                                    <input type="hidden" name="loanacc_id" id="loanacc_id" class="form-control" placeholder="Loan ID">
                                </div>
                                ...
                                <div class="mb-3">
                                    <label for="interestRate" class="form-label">Initial Rate</label>
                                    <input type="text" name="interestRate" id="interestRate" class="form-control" placeholder="Interest Amount">
                                </div>
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            ...
                            <form id="deleteForm" method="POST">
                                <input type="hidden" id="delete_id" name="loanacc_id">
                ...
                <div class="col">
                    <div class="card mt-2">
                        <div class="card-header">
                            <h2 class="text-center display-7">Loan Account</h2>
                                ...
                                <tbody>
                                    <?php if (isset($result) && mysqli_num_rows($result) > 0): ?>
                                        <?php while ($row = mysqli_fetch_assoc($result)): ?>
                                            <tr>
                                                <td class="loanacc_id" style="display: none;"><?php echo $row["loanacc_id"]; ?> </td>
...
<script>
    ...
    $(document).ready(function() {
        $('.delete_btn').click(function(e) {
            e.preventDefault();
            var loanacc_id = $(this).closest('tr').find('.loanacc_id').text();
            $('#delete_id').val(loanacc_id);
            $('#deleteModal').modal('show');
        });

        $('#deleteForm').submit(function(e) {
            e.preventDefault();
            var loanacc_id = $('#delete_id').val();
            $.ajax({
                method: "POST",
                url: "../modal_function/ar_loanaccfunc.php",
                data: {
                    'confirm_delete_btn': true,
                    'loanacc_id': loanacc_id,
                },
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    $.each(response, function(key, value) {
                        ...
                        $('#loanacc_id').val(value['loanacc_id']);
