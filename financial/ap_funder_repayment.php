...
include __DIR__.'/config/ap_funder_conn.php';
include __DIR__.'/config/ap_funder_btnfunc.php';
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header bg-primary text-white">
                            <h1 class="modal-title fs-5" id="editdataLabel">Edit Funder Repayment</h1>
                        </div>
                        <form action="../modal_function/ap_repaymentfunc.php" method="POST">
                ...
                <div class="col">
                    <div class="card mt-2">
                        <div class="card-header">
                            <h2 class="text-center display-7">Funder Repayment</h2>
    ...
    /* delete data*/
        $(document).ready(function() {
            ...
            $('#deleteForm').submit(function(e) {
                ...
                $.ajax({
                    method: "POST",
                    url: "../modal_function/ap_repaymentfunc.php",
                    data: {
