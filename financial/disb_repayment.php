...
include __DIR__.'/config/disb_repayment_conn.php';
include __DIR__.'/config/disb_repayment_btnfunc.php';
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header bg-primary text-white">
                            <h1 class="modal-title fs-5" id="editdataLabel">Edit Repayment</h1>
                        </div>
                        <form action="../modal_function/disb_repaymentfunc.php" method="POST">
                            <div class="modal-body">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="repaymentDate" id="repaymentDate" class="form-control" placeholder="Repayment Date">
                                </div>
                            </div>
                ...
                <div class="col">
                    <div class="card mt-2">
                        <div class="card-header">
                            <h2 class="text-center display-7">Repayment</h2>
                                ...
                                <tbody>
                                    <?php if (isset($result) && mysqli_num_rows($result) > 0): ?>
                                        <?php while ($row = mysqli_fetch_assoc($result)): ?>
                                            <tr>
                                                <td class="repayment_id" style="display: none;"><?php echo $row["repayment_id"]; ?></td>
...
<script>
    ...
    $(document).ready(function() {
        ...
        $('#deleteForm').submit(function(e) {
            ...
            $.ajax({
                method: "POST",
                url: "../modal_function/disb_repaymentfunc.php",
                data: {
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    $.each(response, function(key, value) {
                        ...
                        $('#repaymentDate').val(value['repaymentDate']);
                    });
                    $('#editdata').modal('show');
                }
            });
