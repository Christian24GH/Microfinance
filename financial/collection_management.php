<?php
    ...
    include __DIR__.'/config/collman_conn.php';
    include __DIR__.'/config/collman_btnfunc.php';
    include __DIR__.'/config/disb_loan_conn.php';
    include __DIR__.'/config/disb_conn.php';

    // current date
    $currentDate = date('Y-m-d');
    // select overdue accounts
    $query = "SELECT d.loan_id, b.disbursement_id,  d.amount, d.term, d.status, 
                    b.disbursementDate,
