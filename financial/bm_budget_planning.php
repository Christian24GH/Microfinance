...
include __DIR__.'/config/bm_budplan_conn.php';
include __DIR__.'/config/bm_budplan_btnfunc.php';
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header bg-primary text-white">
                            <h1 class="modal-title fs-5" id="editdataLabel">Edit Budget Planning</h1>
                        </div>
                        <form action="../modal_function/bm_budplanfunc.php" method="POST">
                            <div class="modal-body">
                                <div class="mb-3">
                                    <input type="hidden" name="plan_id" id="plan_id" class="form-control" placeholder="Plan ID">
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="allocatedBudget" id="allocatedBudget" class="form-control" placeholder="Allocated Budget">
                                </div>

                                <div class="mb-3">
                                    <label for="dateCreated" class="form-label">Date Created</label>
                                    <input type="text" name="dateCreated" id="dateCreated" class="form-control" placeholder="Date Created">
                                </div>
                            </div>
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            ...
                            <form id="deleteForm" method="POST">
                                <input type="hidden" id="delete_id" name="plan_id">
                ...
                <div class="col">
                    <div class="card mt-2">
                        <div class="card-header">
                            <h2 class="text-center display-7">Budget Planning</h2>
                                ...
                                <tbody>
                                    <?php if (isset($result) && mysqli_num_rows($result) > 0): ?>
                                        <?php while ($row = mysqli_fetch_assoc($result)): ?>
                                            <tr>
                                                <td class="plan_id"><?php echo $row["plan_id"]; ?> </td>
                                                <td><?php echo $row["planName"]; ?> </td>
                                                <td><?php echo $row["allocatedBudget"]; ?> </td>
...
<script>
    ...
    $(document).ready(function() {
        $('.delete_btn').click(function(e) {
            e.preventDefault();
            var plan_id = $(this).closest('tr').find('.plan_id').text();
        ...
        $('#deleteForm').submit(function(e) {
            e.preventDefault();
            var plan_id = $('#delete_id').val();
            $.ajax({
                method: "POST",
                url: "../modal_function/bm_budplanfunc.php",
                data: {
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    $.each(response, function(key, value) {
                        ...
                        $('#planName').val(value['planName']);
                        $('#allocatedBudget').val(value['allocatedBudget']);
