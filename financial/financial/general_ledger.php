...
include '../config/gl_conn.php';
include '../config/gl_btnfunc.php';
...
<head>
    ...
    <link href="<?php echo __DIR__?>/resources/css/app.css" rel="stylesheet">
    <link href="<?php echo __DIR__?>/resources/css/side.css" rel="stylesheet">
    <link href="<?php echo __DIR__?>/resources/css/accman.css" rel="stylesheet">
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header bg-primary text-white">
                            <h1 class="modal-title fs-5" id="editdataLabel">Edit General Ledger</h1>
                        </div>
                ...
                <div class="col">
                    <div class="card mt-2">
                        <div class="card-header">
                            <h2 class="text-center display-7">General Ledger</h2>
                                ...
                                <tbody>
                                    <?php if (isset($result) && mysqli_num_rows($result) > 0): ?>
                                        <?php while ($row = mysqli_fetch_assoc($result)): ?>
                                            <tr>
                                                <td class="info_id"><?php echo $row["info_id"]; ?> </td>
                                                <td><?php echo $row[""]; ?> </td>
                                                <td><?php echo $row[""]; ?> </td>
                                                <td><?php echo $row[""]; ?> </td>
                                                <td>
