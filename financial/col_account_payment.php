...
include __DIR__.'/config/col_accpay_conn.php';
include __DIR__.'/config/col_accpay_btnfunc.php';
            ...
            <div class="modal fade" id="repay" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="repayLabel" aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <form action="./financial/modal_function/col_accpayfunc.php" method="POST">
                            <div class="modal-body">
                                <div class="mb-3">
