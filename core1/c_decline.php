...
// Update c_status to 'Declined' for the given client_id
$client_id = $_GET["id"];
$sql_status = "UPDATE client_status SET c_status = 'Declined' WHERE client_id = ?";
...
$sql_status = "UPDATE client_status SET l_status = 'Declined' WHERE client_id = ?";
$stmt_status = $conn->prepare($sql_status);
$stmt_status->bind_param("s", $client_id);
$stmt_status->execute();
$stmt_status->close();
