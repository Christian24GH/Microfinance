    ...
    <div class="row mb-3" style="min-height:20vh">
        ...
        <div class="col-auto">
            <div class="card" style="width: 18rem;">
                <div class="card-body ">
                    <h5 class="card-title text-dark-emphasis">On Maintenance</h5>
                    <p class="card-text text-center my-2 lato-light text-dark-emphasis" style="font-size: 2rem; ">0</p>
                    <a href="" class="btn" style="background-color: var(--mfc4);">View Maintenance</a>
                </div>
            </div>
        </div>
        <div class="col-auto">
            <div class="card" style="width: 18rem;">
                <div class="card-body ">
                    <h5 class="card-title text-dark-emphasis">Procurements</h5>
                    <p class="card-text text-center my-2 lato-light text-dark-emphasis"
                        style="font-size: 2rem; ">
                        0 <small class="lato-light" style="font-size:medium;"></small></p>
                    <a href="" class="btn" style="background-color: var(--mfc4);">View Procured Materials</a>
                </div>
            </div>
        </div>
    </div>
