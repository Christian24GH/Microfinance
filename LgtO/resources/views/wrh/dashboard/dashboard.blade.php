        ...
        <div class="col-md-3">
            <div class="card text-white bg-primary shadow-sm">
                <div class="card-body">
                    ...
                    <a href="{{ route('warehouse.index') }}" class="btn btn-light btn-sm">View All</a>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-3">
            <div class="card text-white bg-success shadow-sm">
                <div class="card-body">
                    ...
                    <a href="{{ route('inventory.index') }}" class="btn btn-light btn-sm">View</a>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-3">
            <div class="card text-white bg-info shadow-sm">
                <div class="card-body">
                    ...
                    <a href="{{ route('shipment.index') }}" class="btn btn-light btn-sm">View</a>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-3">
            <div class="card text-white bg-warning shadow-sm">
                <div class="card-body">
                    ...
                    <a href="{{ route('order.index') }}" class="btn btn-light btn-sm">View</a>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-3">
            <div class="card text-white bg-secondary shadow-sm">
                <div class="card-body">
                    ...
                    <a href="{{ route('dock_schedule.index') }}" class="btn btn-light btn-sm">View</a>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-3">
            <div class="card text-white bg-dark shadow-sm">
                <div class="card-body">
                    ...
                    <a href="{{ route('supplier.index') }}" class="btn btn-light btn-sm">View</a>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-3">
            <div class="card text-white bg-danger shadow-sm">
                <div class="card-body">
                    ...
                    <a href="{{ route('quality_check.index') }}" class="btn btn-light btn-sm">View</a>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-3">
            <div class="card text-white bg-teal shadow-sm">
                <div class="card-body">
                    ...
                    <a href="{{ route('lastmile_delivery.index') }}" class="btn btn-light btn-sm">View</a>
                </div>
            </div>
        </div>

        <div class="col-md-3">
            <div class="card text-white bg-indigo shadow-sm">
                <div class="card-body">
                    <h5 class="card-title">RFID Tag</h5>
                    <p class="card-text fs-4">{{ $rfidCount }}</p>
                    <a href="{{ route('rfid_tag.index') }}" class="btn btn-light btn-sm">View</a>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-3">
            <div class="card text-white bg-secondary shadow-sm">
                <div class="card-body">
                    ...
                    <a href="{{ route('wrh_report.index') }}" class="btn btn-light btn-sm">View</a>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="card shadow-sm">
        <div class="card-body p-0">
            <table class="table table-striped mb-0">
                ...
                <tbody>
                    @forelse($recentShipment as $shipment)
                        <tr>
