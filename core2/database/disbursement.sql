...
--
-- Host: localhost:3306
-- Generation Time: May 09, 2025 at 05:21 PM
...
--
-- Dumping data for table `disb_loan_tbl`
--

INSERT INTO `disb_loan_tbl` (`loan_id`, `borrower_id`, `amount`, `term`, `status`) VALUES
(5, 1, 1000.00, '2025-05-02', 'active');
...
--
ALTER TABLE `disbursement_tbl`
  ADD CONSTRAINT `disbursement_tbl_ibfk_1` FOREIGN KEY (`loan_id`) REFERENCES `disb_loan_tbl` (`loan_id`);
