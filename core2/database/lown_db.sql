...
--
-- Host: localhost:3306
-- Generation Time: May 11, 2025 at 05:01 PM
...
INSERT INTO `client_info` (`client_id`, `firstname`, `middlename`, `lastname`, `contact`, `address`, `email`, `birthdate`, `password`, `status`) VALUES
(1, 'John', 'A.', 'Doe', '09171234567', '123 Elm St', 'abello.hannaagatha.bernales@gmail.com', '1990-01-01', 'pass123', 'ACCEPTED'),
(2, 'Jane', 'B.', 'Smith', '09181234567', '456 Oak St', 'cajetapatrick1@gmail.com', '1992-02-02', 'pass456', 'DENIED'),
(3, 'Carlos', 'C.', 'Garcia', '09191234567', '789 Pine St', 'anaselportes22@gmail.com', '1988-03-03', 'pass789', 'PENDING'),
(4, 'Maria', 'D.', 'Reyes', '09201234567', '101 Maple St', 'espedillaannamariedeo@gmail.com', '1995-04-04', 'pass321', 'FLAGGED'),
(5, 'Anna', 'E.', 'Lopez', '09211234567', '202 Birch St', 'anna.lopez@example.com', '1993-05-05', 'pass654', 'ACTIVE');
...
(1, 5, 1000.00, '2025-01-10'),
(2, 5, 1500.00, '2025-02-15'),
(3, 5, 1200.00, '2025-03-05'),
(4, 5, 1800.00, '2025-03-20'),
(5, 5, 2000.00, '2025-04-12'),
(6, 5, 1300.00, '2025-04-25'),
(7, 5, 1700.00, '2025-05-01');
...
(1, 100000.00, 12, 12, 'Home renovation', 1),
(2, 50000.00, 6, 6, 'Tuition fee', 2),
(3, 150000.00, 24, 24, 'Business expansion', 3),
(4, 75000.00, 10, 10, 'Medical expenses', 4),
(5, 200000.00, 36, 36, 'Car purchase', 5);
...
--
-- Dumping data for table `savings_tracking`
--

INSERT INTO `savings_tracking` (`id`, `client_name`, `client_id`, `deposit_date`, `amount_deposited`, `interest_rate`, `maturity_date`, `interest_earned`, `total_amount`, `status`) VALUES
(1, 'John Doe', 12345, '2025-05-01', 10000.00, 5.00, '2026-05-01', 500.00, 10500.00, 'Active'),
(2, 'Jane Smith', 12346, '2025-06-15', 5000.00, 4.50, '2026-06-15', 225.00, 5225.00, 'Active'),
(3, 'Mike Johnson', 12347, '2025-07-20', 15000.00, 6.00, '2026-07-20', 900.00, 15900.00, 'Active'),
(4, 'John Doe', 12345, '2025-05-01', 10000.00, 5.00, '2026-05-01', 500.00, 10500.00, 'Active'),
(5, 'Jane Smith', 12346, '2025-06-15', 5000.00, 4.50, '2026-06-15', 225.00, 5225.00, 'Active'),
(6, 'Mike Johnson', 12347, '2025-07-20', 15000.00, 6.00, '2026-07-20', 900.00, 15900.00, 'Active'),
(7, 'Lucy Gray', 12348, '2024-12-01', 2500.00, 3.00, '2025-12-01', 75.00, 2575.00, 'Active'),
(8, 'Chris Evans', 12349, '2024-11-15', 8000.00, 4.25, '2025-11-15', 340.00, 8340.00, 'Closed'),
(9, 'Sarah Wilson', 12350, '2025-03-10', 20000.00, 4.75, '2026-03-10', 950.00, 20950.00, 'Active'),
(10, 'David Miller', 12351, '2025-02-25', 12000.00, 5.25, '2026-02-25', 630.00, 12630.00, 'Active'),
(11, 'Emma Davis', 12352, '2025-04-05', 3000.00, 4.00, '2026-04-05', 120.00, 3120.00, 'Closed'),
(12, 'Brian Clark', 12353, '2025-01-20', 7000.00, 6.50, '2026-01-20', 455.00, 7455.00, 'Active'),
(13, 'Olivia Lewis', 12354, '2024-10-10', 18000.00, 5.75, '2025-10-10', 1035.00, 19035.00, 'Closed');
